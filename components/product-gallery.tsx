...
export type ProductGalleryImage={src:string;alt:string;label:string};
export default function ProductGallery({images,note="Product reference images. Ask us for photographs of the exact available item."}:{images:ProductGalleryImage[];note?:string}){
